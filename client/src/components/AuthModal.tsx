      ...
      <div className="login-container w-full max-w-md mx-4 relative z-10">
        ...
        <Card className="login-card shadow-2xl border border-white/10 bg-white/5 backdrop-blur-xl">
          <CardContent className="pt-8 pb-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-white mb-3 drop-shadow-lg">بيانات دخول الموظف</h2>
              <p className="text-blue-200/80 text-lg leading-relaxed">الرجاء إدخال بيانات الدخول للوصول إلى نظام تتبع الطلبات</p>
            </div>
